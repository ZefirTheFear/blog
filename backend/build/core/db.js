...
var dbURI = "mongodb+srv://" + process.env.MONGO_USER + ":" + process.env.MONGO_PASSWORD + "@cluster0-zygzu.mongodb.net/" + process.env.MONGO_DATABASE + "?retryWrites=true";
...
exports.connectDB = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.log("DB initial connection error", error_1);
                return [3 /*break*/, 3];
