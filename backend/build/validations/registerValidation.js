...
exports.registerValidation = [
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    if (user) {
                        return [2 /*return*/, Promise.reject("a user with such nickname already exists")];
                    }
                    return [2 /*return*/];
            }
        });
    ...
    express_validator_1.body("email")
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, UserModel_1.default.findOne({ email: value })];
                case 1:
                    user = _a.sent();
                    if (user) {
                        return [2 /*return*/, Promise.reject("a user with such email already exists")];
                    }
                    return [2 /*return*/];
            }
        });
    ...
    express_validator_1.body("confirmPassword").custom(function (value, _a) {
        var req = _a.req;
